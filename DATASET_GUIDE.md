...
Это руководство описывает, как подготовить датасет для обучения и инференса `NpyLabelNet`, а также как организовать данные для совместимости с [TintoraAI](https://github.com/T1desLuck/tintora-ai), нейронной сетью для раскрашивания черно-белых или выцветших фотографий.
